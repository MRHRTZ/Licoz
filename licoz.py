...
#CREATED BY MRHZ
#DON'T RECODE OR YOU WILL TAKE A RISK
#Specially Thanks To Allah SWT
...
def keluar1():
	os.system('clear')
    	print ("\n\n\n\x1b[1;91m[!] Keluar [!]\n\n")
	time.sleep(2)
	print ("\033[1;36m...Jan ngomong ke gw...\n\n")
	time.sleep(2)
	print ("\033[1;39m.....[Turning Off Program].....\033[1;m\n\n")
	time.sleep(3)
	print ("\033[1;30m...Udah pergi sana...\n\n")
	time.sleep(1)
	print ("\033[1;31m\n+_+_+_======[Tools By MRHZ]======_+_+_+\n\n")
	time.sleep(4)
	os.sys.exit()
...
def keluar():
	...
	print ("\n\n\n\x1b[1;91m[!] Keluar [!]\n\n")
	time.sleep(2)
	print ("\033[1;36m...Permintaan Penutupan...\n\n")
	time.sleep(2)
	print ("\033[1;39m.....[Turning Off Program].....\033[1;m\n\n")
	time.sleep(3)
	print ("\033[1;30m...Selamat Tinggal...\n\n")
	time.sleep(1)
	print ("\033[1;31m\n+_+_+_======[Tools By MRHZ]======_+_+_+\n\n")
	time.sleep(4)
    	os.sys.exit()
...
\033[1;31m
 ...
 %% \           %% |     \%%%    % |     %%     %% /     %% /
 \%%%%%%%%%\    %% |      \%%%%%%  /      \%%%%%  /     %%%%%%%%%%%%%%
  \_________\   \_\|       \_____\/        \____\/      \______________\ V1.00 \033[1;m
...
#				''')
		print ('''
               \033[1;33m     _____________________________________  
                   /_____________________________________\ 
                    |                                   |
                    |    Tool Penginstall Kali Linux    |  
                    |                                   |
                    =====================================\033[1;m
                  \033[1;31m___\033[1;37m____\033[1;31m____\033[1;37m____\033[1;31m____\033[1;37m____\033[1;31m____\033[1;37m____\033[1;31m____\033[1;37m____\033[1;31m_____\033[1;m
		 \033[1;31m|\033[1;m\033[1;31m				       	     |\033[1;m
           \033[1;32m+-+-+-[ Author : MRHRTZ | Team : DGC Team Attacker ]-+-+-+\033[1;m
           \033[1;32m+-+-+-[ Tool Kali linux 300+                       ]-+-+-+\033[1;m
           \033[1;96m+-+-+-[ Github : https://github.com/MRHRTZ         ]-+-+-+
           +-+-+-[ Contact Me : 085559038021                  ]-+-+-+\033[1;m
		 \033[1;31m|___\033[1;37m____\033[1;31m____\033[1;37m____\033[1;31m____\033[1;37m____\033[1;31m____\033[1;37m____\033[1;31m____\033[1;37m____\033[1;31m_____|\033[1;m
...
\033[1;32mNOTE : Please Don't Recode!, Coding Mikir Pake Otak :')\033[1;m
		...
		def menu():
			...
			while True:
				print ('''
\033[1;38m1) Tambahkan Kali repository & Perbarui 
2) Lihat kategori
...
\033[1;34m5) Bantuan\033[1;m
			...
			''')
				...
				opcion0 = raw_input("\033[1;33m[LICOZ] >> \033[1;m")
			
		
				while opcion0 == "1":
					os.system('clear')
					print ('''
\033[1;36m1) Tambahkan kali linux repository
2) Perbarui
3) Hapus semua kali linux repository
4) Lihat isi dari file sources.list

					''')
					repo = raw_input("\033[1;32mApa yang kamu inginkan ?> \033[1;m")
					if repo == "1":
						cmd1 = os.system("apt-key adv --keyserver pool.sks-keyservers.net --recv-keys ED444FF07D8D0BF6")
						cmd2 = os.system("echo '# Kali linux repository | Ditambahkan oleh Licoz\ndeb https://http.kali.org/kali kali-rolling main non-free contrib\ndeb-src http://http.kali.org/kali kali-rolling main non-free contrib\n' >> /etc/apt/sources.list \n")
						os.system('clear')
						print ("\033[1;32mRepository telah berhasil ditambahkan !\033[1;m\n")
						raw_input("\033[1;33m[Kembali]")
					elif repo == "2":
						cmd3 = os.system("apt-get update -m")
						print ("\033[1;32Sukses memperbarui\033[1;m\n")
						raw_input("\033[1;33m[Kembali]")
					elif repo == "3":
						infile = "/etc/apt/sources.list"
						outfile = "/etc/apt/sources.list"

						delete_list = ["# Kali linux repository | Ditambahkan oleh Licoz\n", "deb http://http.kali.org/kali kali-rolling main non-free contrib\n", "deb-src http://http.kali.org/kali kali-rolling main non-free contrib\n"]
						fin = open(infile)
						...
						fout.close()
						os.system('clear')
						print ("\033[1;31m\nSemua Repository kali linux telah dihapus !\n\033[1;m")
						raw_input("\033[1;33m[Kembali]")
					elif repo == "pacar":
						os.system('clear')
						print ('''
\033[1;31mMungkin saya tidak bisa mencarikan anda pacar karena saya sendiri jomblo :')\033[1;1m

							''')
						syg1 = raw_input("\033[1;33m>>Sad Banget:' \n\n")
						if syg1 == "iya":
							syg2 = raw_input("\033[1;36m\n>>Hemmm:(( \n\n")
							if syg2 == "jadi gimana?":
								syg4 = raw_input("\033[1;39m\n>>Ya Gatau:'v \n\n")
								if syg4 == "tapi kamu sayang gak?":
									syg5 = raw_input("\033[1;31m\n>>Ama siapa?:(( \n\n")
									if syg5 == "ama nata":
										syg6 = raw_input("\033[1;34m\n>>Sayang Bangettt :^ :^ \n\n")
										if syg6 == "ciee":
											raw_input("\033[1;33m\n>>Hehe :$\n\n")
											raw_input("\x1b[1;37;44m\n \n \n \n \n \n \n \n \n \n 		     [ PROGRAM DIMATIKAN DIA TBTB BERUBAH ]	\n \n \n \n \n \n \n	       		   [ SAVE PROGRAMMER GALAU ] \n \n \n \n \n \n \n \n \033[1;m")
											keluar()							
									else:
										syg7 = raw_input("\033[1;37m\n>>Gak kenal gw huftt\n\n")
										if syg7 == "yaudaa":
											raw_input("\033[1;39m\n>>Udah ahh males\n\n")
										        raw_input("\x1b[1;37;41m\n \n \n \n \n \n \n \n \n \n 		     [ PROGRAM DIMATIKAN USERNYA GALAK BENER ] 	\n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \033[1;m")
											keluar1()
						...
						os.system('clear')
						print ("\033[1;31mMaaf, itu perintah yang salah!\033[1;m\n")
						raw_input("\033[1;33m[Kembali]")
				...
				if opcion0 == "3":
					os.system('clear')
					print (''' 
ClassicMenu Indicator adalah applet area notifikasi (indikator aplikasi) untuk panel atas lingkungan desktop Unity Ubuntu.

Ini menyediakan cara sederhana untuk mendapatkan menu aplikasi bergaya GNOME klasik bagi mereka yang lebih suka ini daripada menu dash Unity.

Seperti menu GNOME klasik, itu termasuk permainan Wine dan aplikasi jika Anda menginstalnya.

Untuk informasi lebih lanjut, silahkan kunjungi : http://www.florian-diesch.de/software/classicmenu-indicator/

''')
					repo = raw_input("\033[1;32mApakah kamu mau memasang indikator menu klasik ? [y/n]> \033[1;m")
					if repo == "y":
						...
						os.system('clear')
						print ("\033[1;31mDibatalkan\033[1;m\n")
						raw_input("\033[1;33m[Kembali]")
						main()

				elif opcion0 == "4"	:
					os.system('clear')
					repo = raw_input("\033[1;32mApakah kamu mau memasang Menu Kali ? [y/n]> \033[1;m")
					if repo == "y":
					...
					os.system('clear')
					print (''' 
\033[1;34m+_+_+_+_+_+_+_+ [Perintah] +_+_+_+_+_+_+_+\033[1;m


\033[1;32mKembali\033[1;m		\033[1;33mUntuk Kembali\033[1;m

\033[1;32mRumah\033[1;m		\033[1;33mPergi ke menu utama\033[1;m

\033[1;32mKeluar\033[1;m		\033[1;33mKeluar Tool ini\033[1;m
		...
		''') 
				...
				def inicio():
					...
					while opcion0 == "2":
						print ('''
\033[1;36m+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+ Semua kategori +_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+\033[1;m

\033[1;33m1) Mengumpulkan Informasi			8) Alat Eksploitasi
2) Analisa Kerentanan   			9) Alat Peradilan
3) Penyerangan Nirkabel				10) Menguji Stres
4) Aplikasi Web 				11) Penyerangan Kata sandi
5) Penyadapan			      		12) Keahlian Bisnis
6) Akses Pertahanan				13) Peretasan Perangkat keras
7) Alat Pelaporan 				14) Lainnya
									
\x1b[1;37;42m0) All\033[1;m

			 ''')
						

						print ("\033[1;32mMasukan kategori atau tekan (0) untuk menginstall semua Kali linux tools .\n\033[1;m")

						opcion1 = raw_input("\033[1;33m[LICOZ] >> \033[1;m")
						if opcion1 == "kembali":
							main()
						elif opcion1 == "rumah":
							main()
						...
						while opcion1 == "1":
							os.system('clear')
							print ('''
\033[1;36m		[ Mengumpulkan Informasi ]\033[1;m

 \033[1;94m1) acccheck					30) lbd
...
\x1b[1;37;42m0) Instal semua Mengumpulkan Informasi tools\033[1;m
				 
						''')
							print ("\033[1;32mMasukan nomer untuk menginstalnya .\n\033[1;m")
							opcion2 = raw_input("\033[1;33m[LICOZ] >> \033[1;m")
							if opcion2 == "1":
						...
						while opcion1 == "2":
							os.system('clear')
							print ('''
\033[1;36m		[ Analisa Kerentanan ]\033[1;m

 \033[1;94m1) BBQSQL				18) Nmap
 2) BED					19) ohrwurm
...
\x1b[1;37;42m0) Instal semua Alat Analisa Kerentanan\033[1;m
						...
						while opcion1 == "3":
							os.system('clear')
							print ('''
		\033[1;36m		[ Penyerangan Nirkabel ]\033[1;m

 \033[1;94m1) Aircrack-ng				17) kalibrate-rtl
...
\x1b[1;37;42m0) Instal semua Alat Penyerangan Nirkabel\033[1;m
						...
						while opcion1 == "4":
							os.system('clear')
							print ('''
\033[1;36m		[ Aplikasi Web ]\033[1;m

 \033[1;94m1) apache-users			21) Parsero
...
\x1b[1;37;42m0) Instal semua Alat Aplikasi Web\033[1;m
						...
						while opcion1 == "5":
							os.system('clear')
							print ('''
\033[1;36m		[ Penyadapan ]\033[1;mn

 \033[1;94m1) Burp Suite				17) rtpmixsound
...
\x1b[1;37;42m0) Instal semua Alat Penyadapan\033[1;m
						...
						while opcion1 == "6":
							os.system('clear')
							print ('''
\033[1;36m		[ Akses Pertahanan ]\033[1;m
...
\x1b[1;37;42m0) Instal semua Alat Akses Pertahanan\033[1;m
						...
						while opcion1 == "7":
							os.system('clear')
							print ('''
\033[1;36m		[ Alat Pelaporan ]\033[1;m
...
\x1b[1;37;42m0) Instal semua Alat Pelaporan\033[1;m
						...
						while opcion1 == "8":
							os.system('clear')
							print ('''
\033[1;36m		[ Alat Eksploitasi ]\033[1;m
...
\x1b[1;37;42m0) Instal semua Alat Eksploitasi\033[1;m
						...
						while opcion1 == "9":
							os.system('clear')
							print ('''
\033[1;36m		[ Alat Peradilan ]\033[1;m

 \033[1;94m1) Binwalk				11) extundelete
...
\x1b[1;37;42m0) Instal semua Alat Peradilan\033[1;m
						...
						while opcion1 == "10":
							os.system('clear')
							print ('''
\033[1;36m		[ Menguji Stres ]\033[1;m
...
\x1b[1;37;42m0) Instal semua Alat Menguji Stres\033[1;m
						...
						while opcion1 == "11":
							os.system('clear')
							print ('''
\033[1;36m		[ Penyerangan Kata sandi ]\033[1;m

 \033[1;94m1) acccheck				19) Maskprocessor
...
\x1b[1;37;42m0) Instal semua Alat Penyerangan Kata sandi\033[1;m
						...
						while opcion1 == "12" :
							os.system('clear')
							print ('''
\033[1;36m		[ Keahlian Bisnis ]\033[1;m
...
\x1b[1;37;42m0) Instal semua Alat Keahlian Bisnis\033[1;m
						...
						while opcion1 == "13" :
							os.system('clear')
							print ('''
\033[1;36m		[ Peretasan Perangkat keras\033[1;m

 \033[1;94m1) android-sdk
 2) apktool
 3) Arduino
 4) dex2jar
 5) Sakis3G	
...
\x1b[1;37;42m0) Instal semua Alat Peretasan Perangkat keras\033[1;m
						...
						while opcion1 == "14" :
							os.system('clear')
							print ('''
\033[1;36m		[ Lainnya ]\033[1;m

\033[1;94mm1) Wifresti
2) Squid3
				''')
							print ("\033[1;32mMasukan nomer untuk menginstalnya .\n\033[1;m")
							opcion2 = raw_input("\033[1;33m[LICOZ] >> \033[1;m")
